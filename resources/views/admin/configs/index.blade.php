        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <form action="{{ route('configs.actions') }}" id="configs_actions_form" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-2 m-1">
                                            <div class="col-md-6 form-group">
                                                <label for="config_name">Filter By Config Name</label>
                                                <input type="text" class="filter_data_table form-control" name="config_name" id="config_name">
                                            </div>
                                            <div class="col-md-6 form-group">
            ...
            <script>
                $('.action_btn').on('click', function(e){
                    ...
                    if(!checkbox.is(":checked")){
                        $('#not_checked_modal_title').text("Plase Select the Configs First");
