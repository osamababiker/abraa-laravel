                        ...
                        <div class="col-12"> 
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title"> You have <span id="members_counter"></span> member in this table  </h5>
                                    <div class="row">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item" href="{{ route('members.export.excel') }}" target="_blank">Export to excel</a>
                                            </div>
                                        </div>
                                    </div>
                                </div> 
                                ...
                                <div class="row mb-2 m-1">
                                    <div class="col-md-4 form-group">
                                        ...
                                        <input type="text" name="member_name" id="member_name" class="filter_data_table form-control" aria-label="Search">
                                    </div>
                                    <div class="col-md-4 form-group">
