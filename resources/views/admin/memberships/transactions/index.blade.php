        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <form id="memberships_transactions_actions_form" action="{{ route('membershipsTransactions.actions') }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title"> You have <span id="memberships_transactions_counter"></span> memberships Plan in this table </h5>
                                         
                                        <div class="row ml-1">
                                            <a href="{{ route('membershipsTransactions.create') }}" class="btn btn-primary"> <i class="fa fa-plus"></i> Add New  </a>
                                            &nbsp; &nbsp;
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item" href="{{ route('membershipsTransactions.export.excel') }}" target="_blank">Export to excel</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-2 m-1">
                                            <div class="col-md-4 form-group">
                                                ...
                                                <select name="payment_status" id="payment_status" class="filter_data_table form-control select2">
                                            ...
                                            <div class="col-md-4 form-group">
                                                ...
                                                <select name="subscription_status" id="subscription_status" class="filter_data_table form-control select2">
                                                    <option value="">Choose Status</option>
                                                    <option value="pending"> pending </option>
                                                </select>
                                            </div>
