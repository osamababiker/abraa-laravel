                                    ...
                                    <form method="post" action="{{ route('membershipsTransactions.store') }}">
                                        ...
                                        <div class="form-row">
                                            ...
                                            <div class="col-md-4 form-group">
                                                ...
                                                <input type="text" name="payment_link" class="form-control" id="payment_link">
                                            </div>
                                            <div class="col-md-4 form-group">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-4 form-group">
                                                ...
                                                <input type="text" name="start_date" id="start_date" class="form-control ymd_datepicker">
                                            </div>
                                            <div class="col-md-4 form-group">
                                                <label for="end_date">End Date</label>
                                                <input type="text" name="end_date" id="end_date" class="form-control ymd_datepicker">
                                            </div>
                                            <div class="col-md-4 form-group">
                                                <label for="payment_date">Payment Date</label>
                                                <input type="text" name="payment_date" id="payment_date" class="form-control ymd_datepicker">
                                            </div>
                                        </div>
