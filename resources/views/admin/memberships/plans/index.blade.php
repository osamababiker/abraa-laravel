        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <form id="membershipsPlans_actions_form" action="{{ route('membershipsPlans.actions') }}" method="post">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h5 class="card-title"> You have <span id="memberships_plans_counter"></span> memberships Plan in this table </h5>
                                         
                                        <div class="row ml-1">
                                            <a href="{{ route('membershipsPlans.create') }}" class="btn btn-primary"> <i class="fa fa-plus"></i> Add New  </a>
                                            &nbsp; &nbsp;
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item" href="{{ route('membershipsPlans.export.excel') }}" target="_blank">Export to excel</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <div class="row mb-2 m-1">
                                            <div class="col-md-6 form-group">
                                                <label for="memberships_plan_name">Search memberships Plans by Name</label>
                                                <input type="text" name="memberships_plan_name" id="memberships_plan_name" class="filter_data_table form-control" aria-label="Search">
                                            </div>
                                            <div class="col-md-6 form-group">
