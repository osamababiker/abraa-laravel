        ...
        <div class="main">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header ml-3">
                                    ...
                                    <div class="row">
                                        <a href="{{ route('paymentOptions.create') }}" target="_blanck" class="btn btn-primary"> <i class="fa fa-plus"></i> Add New </a>
                                        &nbsp; &nbsp;
            ...
            <script>
                ...
                $("form").submit(function(e){
                    ...
                    if(!checkbox.is(":checked")){
                        e.preventDefault();
                        $('#not_checked_modal_title').text("Plase Select Payemnt Option First");
                        $('#not_checked_modal').modal('show');
                    }
                });
            </script>
