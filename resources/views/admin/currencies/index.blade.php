        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <h1 class="h3 mb-3">Currencies Table</h1>

                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header ml-3">
                                    <h5 class="card-title"> You have <span id="Currencies_counter"></span> Currency in
                                        this table </h5>
                                    <div class="row">
                                        <a href="{{ route('currencies.create') }}" target="_blanck" class="btn btn-primary"> <i class="fa fa-plus"></i> Add New </a>
                                        &nbsp; &nbsp;
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item" href="{{ route('currencies.export.excel') }}"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-2 m-1">
                                        <div class="col-md-6 form-group">
                                            <label for="currency_name">Search Currency Name</label>
                                        ...
                                        <table id="" class="table table-striped table-child-wrapper">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Id</th>
                                                    <th>Currency Code</th>
                                                    <th>Currency Name (AR)</th>
                                                    <th>Currency Name (En)</th>
                                                    <th>Status</th>
                                                    <th>Actions</th>
                                                </tr>
                                            </thead>
                                            <tbody id="currencies_table_body">
                                    ...
                                    @endif
                                    @include('admin.currencies.components.delete_selected')
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <script>
                $('.action_btn').on('click', function(e){
                    ...
                    if(!checkbox.is(":checked")){
                        $('#not_checked_modal_title').text("Plase Select the Currencies First");
            ...
            <script src="{{ asset('js/dataTables/currenciesDataTable.js') }}"></script>
            <!-- footer is here -->
