        ...
        <ul class="sidebar-nav">
            <li class="sidebar-item">
                ...
                <ul id="suppliers" class="sidebar-dropdown list-unstyled collapse " data-parent="#sidebar">
                    <li class="sidebar-item"><a class="sidebar-link" href="{{ route('suppliers.index') }}">All supplier</a></li>
                    <li class="sidebar-item"><a class="sidebar-link" href="{{ route('suppliers.organic') }}">Suppliers (Organic)</a>
                    </li>
            ...
            <li class="sidebar-item">
                ...
                <ul id="rfq" class="sidebar-dropdown list-unstyled collapse " data-parent="#sidebar">
                    <li class="sidebar-item"><a class="sidebar-link" href="{{ route('rfq.index') }}">All Quotation</a></li>
                    <li class="sidebar-item"><a class="sidebar-link" href="{{ route('rfq.pending') }}l">Pending Quotation</a>
                    </li>
