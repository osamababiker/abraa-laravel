        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <h1 class="h3 mb-3">Manage Pending Buying Requests Table</h1>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header ml-3">
                                    ...
                                    <div class="row">
                                        <a href="{{ route('rfqs.create') }}" target="_blanck" class="btn btn-primary"> <i class="fa fa-plus"></i> Add New </a>
                                        &nbsp; &nbsp;
                                        <button type="button"
                                            data-target="#approve_selected_confirm" class="btn btn-success action_btn">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item" href="{{ route('rfqs.export.excel') }}"
