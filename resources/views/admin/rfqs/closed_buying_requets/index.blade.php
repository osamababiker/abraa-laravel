        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <h1 class="h3 mb-3">Manage Closed Buying Requests Table</h1>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header ml-3">
                                    ...
                                    Closed Requests in this table </h5>
                                    <div class="row">
                                        <a href="{{ route('closedRfqs.create') }}" target="_blanck" class="btn btn-primary"> <i class="fa fa-plus"></i> Add New </a>
                                        &nbsp; &nbsp;
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item" href="{{ route('closedRfqs.export.excel') }}"
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('closedRfqs.actions') }}" id="buying_request_actions_form" method="post">
                                        @csrf
                                        ...
                                        @endif
                                        @include('admin.rfqs.closed_buying_requets.components.delete_selected')
                                        @include('admin.rfqs.closed_buying_requets.components.approve_selected')
                                    </form>
                                </div>
                            </div>
                        </div>
            ...
            <script src="{{ asset('js/dataTables/closedRfqsDataTable.js') }}"></script>
            <!-- footer is here -->
