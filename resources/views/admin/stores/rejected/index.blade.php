...
<body data-theme="default" data-layout="fluid" data-sidebar-position="left" data-sidebar-behavior="sticky">
    <div class="wrapper">
        ...
        <div class="main">
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header ml-3">
                                        <h5 class="card-title"> You have <span id="stores_counter"></span> rejected store in this
                                            table </h5>
                                        <div class="row">
                                    ...
                                    <div class="card-body">
                                        ...
                                        @endif
                                        @include('admin.stores.rejected.components.approve_selected')
                                        @include('admin.stores.rejected.components.delete_selected')
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <script src="{{ asset('js/dataTables/rejectedStoresDataTable.js') }}"></script>
            <!-- footer is here -->
