...
<body data-theme="default" data-layout="fluid" data-sidebar-position="left" data-sidebar-behavior="sticky">
    <div class="wrapper">
        ...
        <div class="main">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header ml-3">
                                    <h5 class="card-title"> You have <span id="users_counter"></span> user in
                                        this table </h5>
                                    <div class="row">
                                        <a href="{{ route('users.create') }}" target="_blank" class="btn btn-primary"> <i class="fa fa-plus"></i> Add New </a>
                                        &nbsp; &nbsp;
                                ...
                                <div class="card-body">
                                    ...
                                    @endif
                                    @include('admin.users.components.delete_selected')
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <script>
                $('.action_btn').on('click', function(e){
                    ...
                    if(!checkbox.is(":checked")){
                        $('#not_checked_modal_title').text("Plase Select the Users First");
            ...
            <script src="{{ asset('js/dataTables/usersDataTable.js') }}"></script>
            <!-- footer is here -->
