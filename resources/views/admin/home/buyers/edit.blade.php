        ...
        <div class="main"> 
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <h1 class="h3 mb-3"> <i class="fa fa-edit"></i> Edit Home Page Buyer </h1>

                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <form method="post" action="{{ route('homePageBuyers.update') }}" enctype="multipart/form-data">
                                        @csrf 
                                        <input type="hidden" name="buyer_id" value="{{ $buyer->id }}">
                                        <div class="form-row mt-4">
                                            <div class="col-md-6 form-group">
                                                <label for="buyername">Buyer Name</label>
                                                <input type="text" value="{{ $buyer->buyername }}" name="buyername" id="buyername" class="form-control">
                                            </div>
                                            <div class="col-md-6 form-group">
                                                <label for="buyer_link">Buyer Link</label>
                                                <input type="text" value="{{ $buyer->buyer_link }}" name="buyer_link" id="buyer_link" class="form-control">
                                            </div>
                                        </div>
                                        <div class="form-row">
                                            <div class="col-md-12">
