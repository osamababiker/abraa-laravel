        ...
        <div class="main"> 
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <h1 class="h3 mb-3"> <i class="fa fa-edit"></i> Update Slider </h1>

                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <form method="post" action="{{ route('homeSliders.update') }}" enctype="multipart/form-data">
                                        @csrf 
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" value="{{ $slider->link }}" class="form-control" name="link" id="link">
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                ...
                                                <select name="region" id="region" class="form-control select2">
                                                    <option selected value="{{ $slider->language->code }}">{{ $slider->language->name }}</option>
