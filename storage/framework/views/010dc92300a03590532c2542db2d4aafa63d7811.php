            ...
            <div class="pt-2 px-4 ps-lg-0 pe-xl-5 ml-5">
              ...
              <form>
                ...
                <div class="file-drop-area mb-3">
                  <div class="file-drop-icon ci-cloud-upload"></div><span class="file-drop-message"> اسحب وافلت صور المنتج هنا </span>
                  <input name="product_images" class="file-drop-input" type="file">
                ...
                <div class="mb-3 py-2">
                  ...
                  <select  class="form-control select2" multiple="multiple" id="product_tags">
...
<?php /**PATH C:\wamp64\www\dronz\resources\views/vendors/add_product.blade.php ENDPATH**/ ?>