        ...
        <ul class="sidebar-nav">
            <li class="sidebar-item">
                ...
                <ul id="settings" class="sidebar-dropdown list-unstyled collapse " data-parent="#sidebar">
                    <li class="sidebar-item"><a class="sidebar-link" href="<?php echo e(route('configs.index')); ?>">Website Config</a></li>
                    <li class="sidebar-item"><a class="sidebar-link" href="<?php echo e(route('countries.index')); ?>">Website Countries</a></li>
                    <li class="sidebar-item"><a class="sidebar-link" href="<?php echo e(route('states.index')); ?>">Countries States</a></li>
                    <li class="sidebar-item"><a class="sidebar-link" href="<?php echo e(route('currencies.index')); ?>">Website Currencies</a></li>
                    <li class="sidebar-item"><a class="sidebar-link" href="<?php echo e(route('units.index')); ?>">Website Units</a></li>
                    <li class="sidebar-item"><a class="sidebar-link" href="<?php echo e(route('paymentOptions.index')); ?>">Payment Options</a></li>
                </ul>
            </li>
            <li class="sidebar-item">
            ...
            <li class="sidebar-item">
                ...
                <ul id="home_items" class="sidebar-dropdown list-unstyled collapse " data-parent="#sidebar">
                    <li class="sidebar-item"><a class="sidebar-link" href="<?php echo e(route('services.index')); ?>"> Services</a></li>
                </ul>
            </li>
            <li class="sidebar-item">
