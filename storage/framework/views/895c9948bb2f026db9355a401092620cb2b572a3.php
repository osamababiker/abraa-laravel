                                    ...
                                    <div class="row no-gutters w-100">
                                        <div class="col-6">
                                            <div class="illustration-text p-3 m-1">
                                                <h4 class="illustration-text">Welcome Back, Omer!</h4>
                                ...
                                <div class="card-body py-4">
                                    <div class="media">
                                        <div class="media-body">
                                            ...
                                            <h3 class="mb-2">24330</h3>
                                            <p class="mb-2"> Total Active Store </p>
                                            <div class="mb-0">
                                ...
                                <div class="card-body py-4">
                                    <div class="media">
                                        <div class="media-body">
                                            ...
                                            <h3 class="mb-2">15463</h3>
                                            <p class="mb-2">Total Active Products</p>
                                            <div class="mb-0">
                                                <span class="badge badge-soft-success mr-2"> <i
...
<?php /**PATH C:\Abraa\abraa-app\resources\views/admin/index.blade.php ENDPATH**/ ?>