  ...
  <footer class="bg-dark pt-5">
            ...
            <div class="widget pb-2 mb-4">
              ...
              <form class="subscription-form validate" action="https://studio.us12.list-manage.com/subscribe/post?u=c7103e2c981361a6639545bd5&amp;amp;id=29ca296126" method="post" name="mc-embedded-subscribe-form" target="_blank" novalidate>
                <div class="input-group flex-nowrap"><i class="ci-mail position-absolute top-50 translate-middle-y text-muted fs-base ms-3"></i>
                  <input class="form-control rounded-end" type="email" name="EMAIL" placeholder="Your email" required>
            ...
            <div class="col-md-6 text-center text-md-start mb-4">
              <div class="text-nowrap mb-4"><a class="d-inline-block align-middle mt-n1 me-3" href="#"><img class="d-block" src="img/footer-logo-light.png') }}" width="117" alt="Cartzilla"></a>
                <div class="btn-group dropdown disable-autohide">
                  <button class="btn btn-outline-light border-light btn-sm dropdown-toggle px-2" type="button" data-bs-toggle="dropdown"><img class="me-2" src="<?php echo e(asset('site/img/flags/en.png')); ?>" width="20" alt="English">Eng / $</button>
                  <ul class="dropdown-menu my-1">
                    ...
                    <li><a class="dropdown-item pb-1" href="#"><img class="me-2" src="<?php echo e(asset('site/img/flags/fr.png')); ?>" width="20" alt="Français">Français</a></li>
                    <li><a class="dropdown-item pb-1" href="#"><img class="me-2" src="<?php echo e(asset('site/img/flags/de.png')); ?>" width="20" alt="Deutsch">Deutsch</a></li>
                    <li><a class="dropdown-item" href="#"><img class="me-2" src="<?php echo e(asset('site/img/flags/it.png')); ?>" width="20" alt="Italiano">Italiano</a></li>
                  </ul>
                </div>
              </div>
    ...
    <script src="<?php echo e(asset('site/vendor/bootstrap/dist/js/bootstrap.bundle.min.js ')); ?>"></script>
    <script src="<?php echo e(asset('site/vendor/simplebar/dist/simplebar.min.js ')); ?>"></script>
    <script src="<?php echo e(asset('site/vendor/tiny-slider/dist/min/tiny-slider.js ')); ?>"></script>
    <script src="<?php echo e(asset('site/vendor/smooth-scroll/dist/smooth-scroll.polyfills.min.js ')); ?>"></script>
    <script src="<?php echo e(asset('site/vendor/drift-zoom/dist/Drift.min.js ')); ?>"></script>
    <script src="<?php echo e(asset('site/vendor/lightgallery.js ')); ?>/dist/js/lightgallery.min.js ')}}"></script>
    <script src="<?php echo e(asset('site/vendor/lg-video.js ')); ?>/dist/lg-video.min.js ')}}"></script>
    <!-- Main theme script-->
    <script src="<?php echo e(asset('site/js/theme.min.js ')); ?>"></script>
  </body>
</html><?php /**PATH C:\wamp64\www\dronz\resources\views/vendors/store/layouts/footer.blade.php ENDPATH**/ ?>