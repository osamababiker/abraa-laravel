                                    ...
                                    <div class="row no-gutters w-100">
                                        <div class="col-6">
                                            <div class="illustration-text p-3 m-1">
                                                <h4 class="illustration-text">Welcome Back , <?php echo e(Auth::user()->name); ?></h4>
                                ...
                                <div class="card-body py-4">
                                    <div class="media">
                                        <div class="media-body">
                                            <h3 class="mb-2"><?php echo e($pending_stores_count); ?></h3> 
                                            <p class="mb-2"> Store Waiting for Approval </p>
                                            <h3 class="mb-2"> <?php echo e($approved_stores_count); ?> </h3>
                        ...
                        <div class="col-12 col-sm-6 col-md-3 d-flex">
                            <div class="card flex-fill">
                                <div class="card-body py-4">
                                    <div class="media">
                                        <div class="media-body">
                                            <h3 class="mb-2"><?php echo e($pending_items_count); ?></h3>
                                            <p class="mb-2">Pending Products</p>
                                            <h3 class="mb-2"><?php echo e($approved_items_count); ?></h3>
                        ...
                        <div class="col-12 col-sm-6 col-md-3 d-flex">
                            <div class="card flex-fill">
                                <div class="card-body py-4">
                                    <div class="media">
                                        <div class="media-body">
                                            <h3 class="mb-2"><?php echo e($pending_buying_requests_count); ?></h3>
                                            <p class="mb-2">Pending Products RFQ</p>
                                            <h3 class="mb-2"><?php echo e($total_buying_requests_count); ?></h3>
                        ...
                        <div class="col-12 col-sm-6 col-md-3 d-flex">
                            <div class="card flex-fill">
                                <div class="card-body py-4">
                                    <div class="media">
                                        <div class="media-body">
                                            <h3 class="mb-2"><?php echo e($pending_global_buying_requests_count); ?></h3>
                                            <p class="mb-2">Pending Global RFQ</p>
                                            <h3 class="mb-2"><?php echo e($total_global_buying_requests_count); ?></h3>
                                            <p class="mb-2">Total RFQ</p>
                                            <div class="mb-0">
                                                <span class="badge badge-soft-success mr-2"> <i
                                                        class="mdi mdi-arrow-bottom-right"></i> +20 </span>
...
<?php /**PATH C:\wamp64\www\abraa-dash\resources\views/admin/index.blade.php ENDPATH**/ ?>